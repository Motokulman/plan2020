    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Тороговые точки/офисы',
                'ordering': ('name',),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.MaterialBrand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.CharField(default='default_identifiter', help_text='Уникальный неизменяемый идентификатор (только латинские символы)', max_length=20, unique=True)),
                ('name', models.CharField(help_text='Введите тип армирования', max_length=100)),
            ],
            options={
