...
export class MMani  {
  	constructor(par,fun) {  		
        ...
        this.mmBablo=new MMBablo(this,this.window.content,this.otstup,this.otstup,function(s,p,p1){

        })
        this.mmBablo.width= this.window.width- this.otstup*2
        this.mmBablo.height= this.window.height- this.otstup*2 -32
        ...
        this.drawObj=function(){
            ...
            for (var i = 0; i < aobj.length; i++) {
                ...
                for (var j = 0; j < aobjFinal.length; j++) {                   
                    if(aobjFinal[j].obj.obj.id==aobj[i].obj.id){
                        b=j;
                        j==99999999
                    }
                }
...
export class MMBGInfo  {
    constructor() {          
        ...
        this.dragText=function(){            
            if(this.obj.type=="Blok"){
                this.text="id : "+this.obj.obj.id;
                this.text1="количество : "+this.kol;
                this.src="resources/data/"+this.obj.obj.id+"/100.png"
            }
        }
