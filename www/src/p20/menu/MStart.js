...
export class MStart  {
    constructor(par, idArr) {
    	...
    	this.init=function(){
		    ...
		    this.inputS=new DInput(this.w, 204+(par.wh+this.par.otstup)*6, this.par.otstup,"20");
		    this.inputS.height=par.wh/2-2;
		    this.inputS.width=par.wh*2+this.par.otstup-3


		    var b7 = new DButton(this.w, 204+(par.wh+this.par.otstup)*6, this.par.otstup+par.wh/2, "open",function(){
		    ...
		    var b8 = new DButton(this.w, 204+(par.wh+this.par.otstup)*7, this.par.otstup+par.wh/2, "save",function(){
		    ...
		    this.par.array[this.par.array.length]=this.sStyle=new MStyle(this, function(s,p){             
		   	...
		   	this.init3()
		   	var xz="zsdkafjasdkfjabsdfkljdashfasdfkjhasdfkljasdhf"
    	}
