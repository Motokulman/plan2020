...
export class TextureObject {
    constructor(_dCont,_fun) {
        ...
        this.textXZ = function(){   
            ...
            self.texture.repeat.set(self.object.rx, self.object.ry)
            self.texture.offset.set(self.object.px, self.object.py)
        ...
        this.startTextur = function(){  
            this.texture= this.loader.load(this.object.src.src, texture => {
                self.fun('novaTexeur',self.texture)
                self.textXZ()
            })
        ...
        this.redragParam=function(obj){
            ...
            if (this.object.src == undefined) {
                this.object.src = {src:"null33",id:null}               
            }
            
            if(this.objDin.src) this.object.src = {src:this.linkO+this.objDin.src+'',id:null} //FIXE нафиг грохнуть
