...
import { KRBoxRect } from './KRBoxRect.js';
export class KorektRect  {
    constructor(fun) {         
        ...
        this.arrayCesh=[];
        this.arrDin=[];
       // this.arrWin=[{x:3000,y:900,w:1200,h:1120},{x:1500,y:500,w:1000,h:600}]
        this.arrWin=[]
        ...
        this.getR=function(){
            if(this.array[this.sah]==undefined){
                this.array[this.sah]=new KRBoxRect()
...
//////////////////////////////////////////////
        var yyyy=1500
        this.arrLine=[{p:{x:5500,y:200+yyyy},p1:{x:3300,y:-300+yyyy}}]
        ...
        var rrEE={x:0,y:0,x1:100,y1:100,w:10,h:100};
        this.reshikLine1=function(_i,_br, rd){
            ...
            if(rez.tip==0){
                ...
                trace(rez.tip+"::",_br.idArr,rez.pBool)
 ...
 */
            ...
            if(pl0.x>pl1.x)_point=this.calc.isPointInLin(pl0,pl1,aR[0],99999999999,99999999999)//берем нормаль с какой стороны коробка 
            else _point=this.calc.isPointInLin(pl1,pl0,aR[0],99999999999,99999999999)//берем нормаль с какой стороны коробка                       
            rezult.pBool=true
            ...
            sah=0;            
            for (var i = 0; i < aR.length; i++) {
                if(i==0)__point=this.getPointOfIntersection(aR[i],aR[3],pl0,pl1)
                else __point=this.getPointOfIntersection(aR[i],aR[i-1],pl0,pl1)
        ...
        this.setGeom=function(geometry){
            ...
            uv.length=0   
            for (var i = 0; i < this.arrDin.length; i++) {
                this.arrDin[i].setGeom(vertices,uv);
            }
