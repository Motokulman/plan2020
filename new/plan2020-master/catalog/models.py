...
Остановился здесь. Навожу порядок путем разбиения на приложения. Модель каменного материала стоит упроститьт, поскольку все итак прописывается в алгоритмах
